    ...
    return (
        <Container>
            ...
            <Right>
                <Title>Contact</Title>
                <ContactItem>
                    <Room style={{ margin: "5px" }} /> Vasant Kunj , South Delhi 98336
                </ContactItem>
                <ContactItem>
                    <Phone style={{ margin: "5px" }} /> +91 676767676767
                </ContactItem>
                <ContactItem>
                    <Email style={{ margin: "5px" }} />navdeeptest@gmail.com
                </ContactItem>
                <PaymentImage>
